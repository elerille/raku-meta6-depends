...
class Depends-Action {
    method TOP($/) {
        ...
        make Depends.new: name => ~$<name>, :@ver, |%kvargs;
    }
    method ext($/) {
        with $<ver> {
...
#| %depends<*><requires>
#| %depends<*><recommends>
sub depends(META6:D $meta --> Hash:D) is export {
    my %depends;
